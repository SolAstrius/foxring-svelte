import { symbolDataTable, type SymbolData } from "./runeDataset";
...
export function parseString(s: string): RenderableToken[] {
    ...
    while (i < s.length) {
        ...
        let found = false;
        let foundSymbolData: SymbolData | null = null;
        ...
        if (found && foundSymbolData && !isEnglishMode) {
